...
const TalentPoolsSlugPage = ({ params }: { params: { slug: string } }) => {
  ...
  return (
    <div className="p-8">
      ...
      <h1 className="text-3xl font-bold mb-6">Talent Pool {params.slug}</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Talent Pool List</CardTitle>
          <CardDescription>
            Manage and review your talent pool candidates
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
...
export default TalentPoolsSlugPage;
