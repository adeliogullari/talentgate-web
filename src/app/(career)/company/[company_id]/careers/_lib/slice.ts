...
>(
    ...
    async(company_id, thunkAPI) => {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/careers/companies/${company_id}/jobs`, {
            method: 'GET',
...
export const careerJobsSlice = createSlice({name: 'careerJobsSlice', initialState: CareerJobsInitialState, reducers: {},
